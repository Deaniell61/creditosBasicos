<ul id="tabsn" class="tabsUsuarios centrartab blue darken-1 ">
    <div class="lipUsuario">
           ...
           <li class="centrarli"><a id="vendedor" href="#" class="amber accent-4 btn white-text tamatabsa  ">Otorgante</a></li>
           <li class="centrarli"><a id="flujo" href="#" class=" yellow darken-4 btn white-text tamatabsa  ">Flujo</a></li>
           <li class="centrarli"><a id="estadisticaCredito" href="#" class="amber accent-4 btn white-text tamatabsa  ">Creditos</a></li>
           <li class="centrarli"><a id="estadisticaClientes" href="#" class=" amber accent-4 btn white-text tamatabsa  ">Clientes</a></li>
           <li class="centrarli"><a id="estadisticaDesembolso" href="#" class=" amber accent-4 btn white-text tamatabsa  ">Desembolso</a></li>
...
<div class="input-field col s12">
								...
								?>
									...
									<div class="col m12 borde">
										<div class="col s6" >
											...
											<br>
														<div class="col s8">
                                                             <label class="active" for="fecha" >Total Recaudado</label>
													    ...
													    <div class="col s8">
                                                             <label class="active" for="fecha" >Mora Recaudad</label>
                                                           <input  id="abonosCobrados1111" class="fechas" type="text"   class="validate"  value="">


													    </div>
                              <div class="col s8">
                                                             <label class="active" for="fecha" >Otros Ingresos de Administracion</label>
                                                           <input  id="abonosCobrados1111" class="fechas" type="text"   class="validate"  value="">
										         ...
										         <div class=" col s6">
													    ...
													    <div class="col s8">
                                                             <label class="active" for="fecha" >Monto Posible Desenbolso</label>
													    ...
													    <div class="col s8">
                                                             <label class="active" for="fecha" >Pagos de Comision</label>
													   ...
													   <div class="col s2">
												        ...
												        <div class="col s8">
                                                             <label class="active" for="fecha" >Pago de Sueldos</label>
                   ...
                   <div class="row">
                     <div class="col s3 ">
                       <label class="active"  >Cliente Activo</label>
                     <input  id="clienteActivo" class="fechas" type="text"   class="validate"  value="">
                     </div>
                     <div class="col s3 ">
                       <label class="active"  >Prestamos Activos</label>
                     <input  id="prestamosActivo" class="fechas" type="text"   class="validate"  value="">
                     </div>
                     <div class="col s3 ">
                       <label class="active"  >Cantidad Posible de Desenbolso</label>
                     <input  id="cantidadPD" class="fechas" type="text"   class="validate"  value="">
                     </div>
                     <div class="col s3 ">
                       <label class="active">Credito No Autorizado</label>
                     <input  id="creditonoA" class="fechas" type="text"   class="validate"  value="">
                     </div>
                   </div>
