 ...
 <!-- ********************************** tabla inicio ********************************** -->
      ...
      <div class="row">
      <?php
	  if($_SESSION['SOFT_ACCESOAgrega'.'Creditos']=='1')
				{
	  ?>
           <div>
         	<ul>

         		<li class="centrarli"><a id="generarV" href="#!" class="amber accent-3 btn white-text tamaniobot " ><i class="material-icons left"><img class="iconotab" src="../app/img/generarv.png" /></i>Generar Credito</a></li>
         		  <li class="centrarli"><a id="anularV" href="#!" class="red accent-3 btn white-text tamaniobot " ><i class="material-icons left"><img class="iconotab" src="../app/img/generarv.png" /></i>Anular Credito</a></li>
         	</ul>
          </div>
