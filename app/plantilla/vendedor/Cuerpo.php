<ul id="tabsn" class="tabsUsuarios centrartab blue darken-1 ">
    <div class="lipUsuario">
           ...
           <li class="centrarli"><a id="vendedor" href="#" class=" yellow darken-4 btn white-text tamatabsa  ">Otorgante</a></li>
           <li class="centrarli"><a id="flujo" href="#" class=" amber accent-4 btn white-text tamatabsa  ">Flujo</a></li>
           <li class="centrarli"><a id="estadisticaCredito" href="#" class=" btn white-text amber accent-4  tamatabsa  ">Creditos</a></li>
