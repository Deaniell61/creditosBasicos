...
function anularCredito(id)
{
	...
	if(confirm("Desea anular esta Credito?"))
		{
        $.ajax
        ({
            type:"POST",
...
function verificaProductoCredito()
{

	if(document.getElementById('codigoProd').value!="")
	{
		ingresoCredito(document.getElementById('codigoProd').value);
	}
	else
	{
...
function cargarDetalleCreditos(id)
{
	var  trasDato;
	trasDato = 5;
